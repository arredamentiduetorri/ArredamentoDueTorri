export default {
	...
	errore404: {
		...
		testo: "The link might be wrong, or the page has moved. Try going back to the home page or take a look at our products.",
		bottoneHome: 'Back to home',
		bottoneProdotti: 'Go to products',
	},
} as const;
